...
Contributors: nToklo
Donate link: http://ntoklo.com
Tags: wordpress, e-commerce, recommedations, retail, ntoklo
...
1. You can either install via the Plugins > Add new menu item in your WordPress admin or download recommendations-for-woocommerce-recommendations.zip from the WordPress plugin directory (if you’ve done the latter, you’ll need to upload this file to the /wp-content/plugins/ directory of your store and then unzip it.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Create an nToklo account as instructed on the "WooCommerce > nToklo Recommendation > Settings" tab.
4. Once that’s done you need to let people use your site for at least 24 hours. Please note that we cannot show you recommendations or charts until we have some user activity posted to our servers.
5. Place widgets on your pages using either the widget menu, or by using shortcode calls like: 
...
3. Your nToklo account has now been created, and you'll see a code in the right-hand panel.Copy the code into the left-hand panel to link your WordPress store with your nToklo account.
4. Successfully created your nToklo account and follow the instruction to place widget into your site.
5. Placing the widgets into your site via Appearance > Widgets.
...
6. Recommendations showing on a page using the widgets - you get seven styles and six colour schemes to choose from.
7. View a real time Chart under Admin > nToklo Recommendation > Analytics tab. You can also launch and regularly check your stores nToklo console. It provides retail-focussed analytics giving you a complete picture of user activity on your store..
